...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bluetooth Tracking
        Intent intent = new Intent(MapsActivityCurrentPlace.this, BluetoothTrackingService.class);
        intent.setAction("1");
        startService(intent);

        // Location Tracking
        intent  = new Intent(MapsActivityCurrentPlace.this, LocationTrackingService.class);
        startService(intent);
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        // heat map to represent the crowded areas
        addHeatMap();
    }

    private void addHeatMap() {
        List<LatLng> list = new ArrayList<>();
        // add placeholder to replicate data from other users
        list.add(new LatLng(42.4086189, -72.5337638));
        list.add(new LatLng(42.4086490, -72.5338791));
        list.add(new LatLng(42.4086189, -72.5337638));
        list.add(new LatLng(42.4088509, -72.5337638));
        list.add(new LatLng(42.408292, -72.5337638));
        list.add(new LatLng(42.408292, -72.5334));
        list.add(new LatLng(42.405, -72.529584));
        list.add(new LatLng(42.40777, -72.534709));
        list.add(new LatLng(42.40677, -72.538709));
